...
class JobState(models.Model):
    job_state = models.CharField("JobState", max_length=40, choices=STATE_CHOICES, default="JobState")
...
class JobPost(models.Model):
    ...
    job_state = models.ForeignKey(JobState, on_delete=models.CASCADE, blank=True, null=True)
...
class JobPostActivity(models.Model):
    ...
    job_state = models.ForeignKey(JobState, on_delete=models.SET_NULL, null=True)
    ...
    class StateLog(models.MOdel):
        ...
        status = models.ForeignKey(JobState, on_delete=models.SET_NULL, null=True)
